...
% Set the font to times new roman for main body text
\usepackage{times}
...
% Make captions 10pt (footnotesize) and sans font (equivalent to helvetica) and put the label
% (eg. "Figure X") in bold and set text spacing to 1.5 (stretch=1.5).
\usepackage[font={sf, footnotesize, stretch=1.5}, labelfont={sf, bf}]{caption}
...
% Also the GS team has *specifically* requested that the running titles
% shown in the header of pages should not be full capitals (TABLE OF CONTENTS)
% because clearly that takes away from the readability.
% This is fixed with the nouppercase statement
\iftoggle{bind}{
    ...
    \newcommand{\unnumberedchapter}[1]{ % Preparation for unnumbered chapters 
        ...
        % unnumbered
        \fancyhead[RE]{{\nouppercase{\bfseries #1}}} % Headers for left pages
...
% This is required to stop certain words from bleeding into the
% margins.
